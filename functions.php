...
/* Define Directory Constants */
    ...
    define( 'RTP_CHILD_ASSETS', get_stylesheet_directory_uri() . '/assets' );
    define( 'RTP_CHILD_BOWER_COMPONENTS', get_stylesheet_directory_uri() . '/assets/foundation/bower_components' );
